...
#[sea_orm(table_name = "scores_taiko")]
pub struct Model {
    #[sea_orm(primary_key)]
    pub id: i64,
    pub user_id: i32,
...
pub enum Relation {
    ...
    LeaderboardTaiko,
    #[sea_orm(has_many = "super::score_performances_taiko::Entity")]
...
impl Related<super::score_performances_taiko::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::ScorePerformancesTaiko.def()
    }
}
