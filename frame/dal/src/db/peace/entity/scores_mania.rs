...
#[sea_orm(table_name = "scores_mania")]
pub struct Model {
    #[sea_orm(primary_key)]
    pub id: i64,
    pub user_id: i32,
...
pub enum Relation {
    ...
    LeaderboardMania,
    #[sea_orm(has_many = "super::score_pp_mania::Entity")]
    ScorePpMania,
    #[sea_orm(
...
impl Related<super::score_pp_mania::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::ScorePpMania.def()
    }
}
