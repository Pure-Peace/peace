...
pub enum Relation {
    ...
    #[sea_orm(
        has_many = "super::score_performances_standard_autopilot::Entity"
    )]
...
impl Related<super::score_performances_standard_autopilot::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::ScorePerformancesStandardAutopilot.def()
    }
}
