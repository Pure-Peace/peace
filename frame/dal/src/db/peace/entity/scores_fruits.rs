...
pub enum Relation {
    ...
    LeaderboardFruits,
    #[sea_orm(has_many = "super::score_performances_fruits::Entity")]
...
impl Related<super::score_performances_fruits::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::ScorePerformancesFruits.def()
    }
}
